SELECT
    ...
    (doc -> 'DForms' -> 'clinical_care_generic' -> 0 -> 'DFields' -> 'values' -> 'type_of_care' ->> 'df_value')::text AS type_of_care,
    (doc -> 'DForms' -> 'clinical_care_generic' -> 0 -> 'DFields' -> 'values' -> 'health_facility_name' ->> 'df_value')::text AS health_facility_name,
    (doc -> 'DForms' -> 'clinical_care_generic' -> 0 -> 'DFields' -> 'values' -> 'date_of_admission' ->> 'df_value')::text AS date_of_admission,
    (doc -> 'DForms' -> 'clinical_care_generic' -> 0 -> 'DFields' -> 'values' -> 'inpatient_number' ->> 'df_value')::text AS inpatient_number,
    (doc -> 'DForms' -> 'clinical_care_generic' -> 0 -> 'DFields' -> 'values' -> 'outcome_of_patient' ->> 'df_value')::text AS outcome_of_patient,
    (doc -> 'DForms' -> 'clinical_care_generic' -> 0 -> 'DFields' -> 'values' -> 'date_of_death' ->> 'df_value')::text AS date_of_death,
    (doc -> 'DForms' -> 'clinical_care_generic' -> 0 -> 'DFields' -> 'values' -> 'status_of_patient' ->> 'df_value')::text AS status_of_patient,
    ...
    (doc -> 'DForms' -> 'laboratory_information_diarrhoeal_disease' -> 0 -> 'DFields' -> 'values' -> 'laboratory_name' ->> 'df_value')::text AS laboratory_name,
    ...
    (doc -> 'DForms' -> 'laboratory_information_diarrhoeal_disease' -> 0 -> 'DFields' -> 'values' -> 'laboratory_sample_collected' ->> 'df_value')::text AS laboratory_sample_collected,
